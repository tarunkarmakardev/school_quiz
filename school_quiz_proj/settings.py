"""
Django settings for school_quiz_proj project.
...
ROOT_URLCONF = 'school_quiz_proj.urls'
...
WSGI_APPLICATION = 'school_quiz_proj.wsgi.application'
...
STATICFILES_DIRS = [
    BASE_DIR / "school_quiz_proj/static",
]
